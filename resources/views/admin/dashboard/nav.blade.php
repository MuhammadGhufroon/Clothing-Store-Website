<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <ul class="navbar-nav  justify-content-end">     
            ...
            <style>
        /* CSS Anda yang telah disesuaikan */
        .img-logo {
            width: 130px;
            height: auto;
        }
    ...
    @if(Auth::user()->roles === 'admin' || Auth::user()->roles === 'owner' || Auth::user()->roles === 'manager')
        <li class="nav-item profile-dropdown">
            <a href="#" class="nav-link text-body font-weight-bold px-0">
                <i class="fa fa-user me-sm-1"></i>
                <span class="d-sm-inline d-none">{{ Auth::user()->name }}</span>
                <span class="d-sm-inline d-none"> - {{ Auth::user()->roles }}</span>
            </a>
            <ul class="profile-dropdown-menu">
                ...
                <li style="margin:0">
                <a href="/login">
                    <i class="fa fa-user me-sm-1"></i> Sign In
                </a>
              </li>
                <li style="margin:0">
                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); logoutWithAlert();">
